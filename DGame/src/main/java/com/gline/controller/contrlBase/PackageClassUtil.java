package com.gline.controller.contrlBase;
...
public class PackageClassUtil 
{
	 ...
	 */
	public static List<Class<?>> getClass(String packageName, boolean childPackage) 
	{
	...
	public static List<String> getClassName(String packageName, boolean childPackage) 
	{
		...
		if (url != null) {
			...
			fileNames = getClassNameByJars(urls, packagePath, childPackage);
		}
		return fileNames;
	}
